...
def search():
    ...
    print(f"{total}, {page}, {current_app.config['POSTS_PER_PAGE']}; {type(total)}, {type(page)}, {type(current_app.config['POSTS_PER_PAGE'])}")
...
@bp.route('/new/message/<recipient>', methods=['GET', 'POST'])
@login_required
